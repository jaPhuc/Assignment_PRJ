    ...
    <style>
        ...
        * {
        ...
        .container {
            ...
            width: 768px;
            max-width: 100%;
            min-height: 650px; /* Tăng chiều cao để chứa form Sign Up */
        }
        ...
        /* Thay đổi màu chữ ở overlay để dễ đọc hơn */
        .overlay-panel h1,
        .overlay-panel p,
        ...
        /* Ẩn social container không dùng trong auth.jsp */
        .social-container {
            display: none;
        }
    </style>
    ...
    <div class="container" id="container">
        ...
        <div class="form-container signup-container">
            <form method="post" action="Register">
                ...
                <input type="text" name="phoneNumber" placeholder="Optional">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            signupForm.onsubmit = function (event) {
                ...
                // Nếu có lỗi, hiển thị alert (thay cho modal)
                if (errorMessage !== "") {
                    alert(errorMessage);
                } else {
                    signupForm.submit(); // Nếu không có lỗi, submit form
                }
            };

            // Xử lý thông báo từ server (dùng alert thay modal)
            ...
            if (message !== "") {
                alert(message);
                setTimeout(() => {
                    container.classList.remove("right-panel-active"); // Quay lại form Login
                }, 2000);
            }
